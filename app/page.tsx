...
export default function Home() {
  ...
  return(
    <>
     <Navbar  />
     <Image className="absolute h-screen top-0 right-0 z-0 " src="frame.svg" width={1097} height={853} alt="frame" />
     <div className=" blur-[300px] w-[900px] h-[800px] bg-[#98AEF1] rounded-full absolute top-[-200px] left-[-200px] z-0"></div>
      ...
      <div className="absolute flex justify-center items-end gap-10 h-[400px] overflow-hidden w-[132%] bottom-2 left-[-200px]">
        ...
        <div className=" w-[28%] text-darkPurple rounded-3xl bg-white flex flex-col justify-start items-start pt-10 pb-5 px-7 h-[300px]">
