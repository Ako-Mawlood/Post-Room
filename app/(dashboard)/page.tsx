...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <section className="flex flex-col md:flex-row md:h-[80vh] items-start md:items-center mx-3 my-10 md:w-11/12 md:mx-auto mt-10 rounded-[40px] bg-black">
        <Image
          className="w-full h-full md:w-1/2 rounded-[40px] md:rounded-tl-none md:rounded-bl-none md:order-2"
          src={moon}
          alt="artimage"
          width={800}
          height={850}
        ...
        />
        <div className="flex flex-col md:w-1/2 justify-between text-gray-200 font-semibold p-6">
