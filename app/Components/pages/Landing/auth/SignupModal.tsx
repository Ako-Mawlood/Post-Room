    ...
    <div className="flex flex-col justify-between items-center w-full md:w-2/3 gap-10 p-4">
      ...
      <main className="flex flex-col gap-4 items-center w-full text-md p-4 text-gray-700 font-semibold">
        <AuthOptions isNewUser={isNewUser}>
          <Button onClick={() => setIsSignupFormVisable(true)} variant="outline" className="w-full flex justify-center">
            {" "}
        ...
        <p className="pt-10 text-gray-500 text-sm text-center font-normal">
          ...
          <Link href="/" className="underline underline-offset-2 decoration-black">
            Terms of Service
          </Link>
