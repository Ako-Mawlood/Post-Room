      ...
      {previewBlogs.map((blog, index) => (
        <div
          ...
          <div className="flex flex-col md:flex-row w-full h-3/5 absolute md:relative">
            ...
            <Image src={blog.src} className="w-full h-full object-cover z-0" fill={true} sizes="(min-width: 2540px) 720px, (min-width: 1720px) calc(9.75vw + 474px), (min-width: 780px) calc(40.87vw - 57px), 100vw" alt="Blog image" />
          </div>
