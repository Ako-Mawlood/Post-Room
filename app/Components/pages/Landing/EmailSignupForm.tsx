  ...
  return (
    <main className="flex flex-col items-center gap-12 w-full sm:w-1/2">
      <div className="flex flex-col gap-6 text-center px-4">
        ...
        <p>
          Enter your email address to create an account, and we&#8217;ll send a magic link
          to your inbox.
        </p>
      </div>
      <form
          ...
          <div className="w-full relative">
            <Input
              ...
              className={clsx("w-full text-start bg-slate-100", {
                ...
                "border-red-400": errors.email?.message || error,
              })}
            />
            {errors.email?.message && (
          ...
          <div className="w-full relative">
            <Input
              ...
              className={clsx("w-full bg-slate-100", {
                ...
                "border-red-400": errors.password?.message || error,
              })}
            />
            {errors.password?.message && (
              <CgDanger className="size-5 absolute right-2 top-3 text-red-400" />
